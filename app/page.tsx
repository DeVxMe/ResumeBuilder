    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-6xl font-heading font-bold text-gray-900 mb-6 leading-tight">
          ...
          <div className="flex items-center justify-center gap-6 mb-10 text-sm text-gray-600">
            <div className="flex items-center gap-2">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="text-center hover:shadow-lg transition-all duration-300 border-0 shadow-md">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="font-heading text-xl">Instant Resume Creation</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="text-center hover:shadow-lg transition-all duration-300 border-0 shadow-md">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="font-heading text-xl">Free PDF & Word Export</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base leading-relaxed">
          ...
          <Card className="text-center hover:shadow-lg transition-all duration-300 border-0 shadow-md">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="font-heading text-xl">ATS-Friendly Templates</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base leading-relaxed">
